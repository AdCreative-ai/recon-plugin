...
For architecture questions or edits, start with
[the repository architecture router](architecture/README.md), then load only
the linked source, decision, or verification instructions needed for the task.
...
| `architecture/` | Concise repository architecture contract: responsibility, typed interfaces and dependencies, execution/storage and failure boundaries, source entrypoints, planned changes, owning decisions, and verification. |
